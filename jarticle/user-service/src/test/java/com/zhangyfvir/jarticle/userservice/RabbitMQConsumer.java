...
import com.zhangyfvir.jarticle.userservice.components.rabbitmq.RabbitConsumerUtil;
...
public class RabbitMQConsumer {
    ...
    public void testConsumerUtil() {
        ...
        RabbitConsumerUtil mqUtil = new RabbitConsumerUtil(rabbitConfig);
        mqUtil.receive();
